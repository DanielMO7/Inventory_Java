        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-primary">
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a style="margin-left: 12px ; border: none" class="btn btn-outline-light" href="Controlador?menu=Empleado&accion=mostrar" target="myframe" >Empleado</a>
                        </li>
                         <li class="nav-item">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="#">
                                <img src="img/calavera.jpg" alt="" width="60"/>
                            </a>  
